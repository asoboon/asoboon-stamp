/* ASOBooN AUTO呼出 / LINE通知 連携ブリッジ
 * LINEユーザーまで紐付いた時だけ「完了」とする。
 * アクセストークンはlocalStorageへ保存しない。
 */
(()=>{
'use strict';
