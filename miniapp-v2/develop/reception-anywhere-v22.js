...
function moveTestSlot(){
  ...
  const current=root.querySelector('#recSlots [data-rec-slot="0042"][data-rec-available="1"]');
  root.querySelectorAll('#recSlots [data-rec-slot="0042"]:not([data-rec-available="1"])').forEach(el=>el.remove());
