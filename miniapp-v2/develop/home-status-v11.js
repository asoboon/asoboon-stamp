...
const emit=detail=>{window.ASOBOON_HOME_STATUS_SNAPSHOT=detail;window.dispatchEvent(new CustomEvent('asoboon:v8-home-status',{detail}))};
...
window.ASOBOON_V11_HOME_STATUS=Object.freeze({refresh,start,stop});
start();
})();