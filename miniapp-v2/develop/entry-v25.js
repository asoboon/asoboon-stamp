 ...
 <div class="pv7-body">
  <section class="v25-entry-section">
   ...
   <div class="v25-flow">
    ...
    <div class="v25-step"><b>2</b><div><strong>受付番号を準備</strong><small>HOMEのTODAY PASSまたは呼出状況に表示される受付番号をご用意ください。</small></div></div>
  ...
  <section class="v25-entry-section reentry">
   ...
   <div class="v25-choice-grid" aria-label="一時退場の種類">
    <div class="v25-choice all"><span>ご家族全員で外へ</span><strong>レシートを保管</strong><small>戻るときに必要です</small></div>
    <div class="v25-choice adult"><span>保護者だけ外へ</span><strong>黄色ホルダー</strong><small>館内に別の保護者が必要</small></div>
   </div>

   <article class="v25-reentry-card all">
    <div class="v25-card-head"><span>ご家族全員で外へ出る</span><h3>全員で一時退場する場合</h3></div>
    <ol class="v25-steps">
     <li><b>1</b><div><strong>ロッカーを空にする</strong><small>荷物を残したまま外へ出ないでください。</small></div></li>
     <li><b>2</b><div><strong>赤ホルダーからレシートを抜いて保管</strong><small>再入場時に必要です。なくさないようにお持ちください。</small></div></li>
     <li><b>3</b><div><strong>すべてのホルダーを返却</strong><small>返却ボックスへ入れてから一時退場してください。</small></div></li>
     <li><b>4</b><div><strong>再入場時にレシートを提示</strong><small>スタッフが確認後、再入場できます。</small></div></li>
    </ol>
    <div class="v25-ticket-note"><strong>再入場にはレシートが必要です</strong></div>
   </article>

   <article class="v25-reentry-card adult">
    <div class="v25-card-head"><span>保護者だけ外へ出る</span><h3>大人だけ外出する場合</h3></div>
    <p class="v25-adult-lead">黄色ホルダーをお持ちの保護者のみ外出できます。</p>
    <div class="v25-condition"><b>条件</b><strong>館内に別の保護者が残っていること</strong></div>
   </article>
