const CACHE='boonrun-20260815-v123-rc4-machine-card-layout';
const CORE=['./','./index.html','./style.css?v=20260815-v123-rc4-machine-card-layout','./game.bundle.js?v=20260815-v123-rc4-machine-card-layout','./run-ranking.js?v=20260815-v123-rc3-mobile-balance','./manifest.webmanifest','./assets/world-drive/manifest.json','./assets/world-drive/BACKGROUND-ASSET-GUIDE.md','./assets/world-drive/01-day-highway/far.webp','./assets/world-drive/01-day-highway/mid.webp','./assets/world-drive/01-day-highway/near.webp'];
