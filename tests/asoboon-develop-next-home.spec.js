...
async function installNextHome(page, liffMode = 'resolve', statusFixture = null, options = {}) {
  ...
  const crowdFixture = options.crowdFixture || [
    { waitTypeId:'0030', waitTypeName:'10時ご入場枠【WEB整理券】', slotKey:'10:00', detailedWaitType:'10時ご入場枠【WEB整理券】', reserveUnit:'PERSON', evidence:'PERSON', matchMode:'exact-name', remaining:195 },
    { waitTypeId:'0032', waitTypeName:'12時半ご入場枠【WEB整理券】', slotKey:'12:30', detailedWaitType:'12時半ご入場枠【WEB整理券】', reserveUnit:'PERSON', evidence:'PERSON', matchMode:'exact-name', remaining:71 },
    { waitTypeId:'0034', waitTypeName:'15時ご入場枠【WEB整理券】', slotKey:'15:00', detailedWaitType:'15時ご入場枠【WEB整理券】', reserveUnit:'PERSON', evidence:'PERSON', matchMode:'exact-name', remaining:25 },
  ];
