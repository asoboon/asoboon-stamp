...
words.push(
  {tag:"TECH",name:"NFC",short:"スマホを「かざす」だけで情報をやり取りする近距離通信。",detail:"Near Field Communication の略。交通系ICカードやタッチ決済などにも使われる技術です。",aso:"ASOBooNでは、スタンプラリーなど『操作を減らして体験を始める』仕組みと相性が良い技術です。",source:"https://www.sony.co.jp/Products/felica/NFC/"},
  {tag:"UX",name:"タッチポイント",short:"お客様とASOBooNが接する一つひとつの場所・瞬間。",detail:"Instagram、検索結果、予約画面、駐車場、受付、スタッフの声かけ、退場後のLINEなど、体験の接点を指します。",aso:"館内だけでなく、来場前から帰宅後までをひと続きの体験として見ます。",source:""},
  {tag:"UX",name:"フリクション",short:"『面倒・不安・分かりにくい』など、次の行動を止める摩擦。",detail:"入力項目が多い、どこを押すか分からない、待ち時間が見えない、といった小さな不便もフリクションです。",aso:"予約や呼出状況を分かりやすくするのは、遊ぶ前のフリクションを減らす改善です。",source:""},
  {tag:"DESIGN",name:"アフォーダンス",short:"環境やモノが『こう使えそう』と自然に感じさせる性質。",detail:"説明文を読まなくても、押せそうなボタン、座れそうな形、登れそうな場所など、環境が行動の可能性を示す考え方です。",aso:"『触っちゃダメ』を増やすより、自然に『こっちで遊びたい』と思える環境をつくる発想につながります。",source:""},
  {tag:"EXPERIENCE",name:"ゲーミフィケーション",short:"ゲームの仕組みを、ゲーム以外の体験に取り入れること。",detail:"スタンプ、進捗、達成、抽選、発見などを使って、行動そのものを少し楽しくする設計です。",aso:"アンケートをガチャにする、LINE登録をスタンプラリーにする、など『お願い』を体験に変える時に使えます。",source:""},
  {tag:"MARKETING",name:"リテンション",short:"一度来てくれた人との関係が続き、また利用してもらうこと。",detail:"新しいお客様を増やすことだけでなく、既存のお客様が再び選んでくれる状態をつくる考え方です。",aso:"ASOBooNでは『一度選ばれる。もう一度選ばれる。』の後半にあたります。",source:""},
  {tag:"MARKETING",name:"LTV",short:"一人のお客様との長い関係から生まれる価値。",detail:"Life Time Value の略。1回の売上だけでなく、継続利用や紹介などを含めて長期的な価値を見る考え方です。",aso:"『今日の来場者数』だけでなく、また来たいと思ってもらえる体験を重視する理由の一つです。",source:""}
);
